...
\begin{enumerate}[(a)]
\item $\ket{+} = \frac{1}{\sqrt{2}}(\ket{0}+\ket{1})$ and $e^{i\pi/8}\ket{+} = \frac{e^{i\pi/8}}{\sqrt{2}}(\ket{0}+\ket{1})$
\item $\ket{+} = \frac{1}{\sqrt{2}}(\ket{0}+\ket{1})$ and $\ket{-} = \frac{1}{\sqrt{2}}(\ket{0}-\ket{1})$
